...
public class MarkdownUtil {
    ...
    public static String toHtml(String markdown) {
        ...
        return "<html><head><style>"
                ...
                + "h1, h2, h3, h4 { color: #f4f4f5; font-weight: 600; margin-top: 14px; margin-bottom: 6px; border-bottom: 1px solid #3f3f46; padding-bottom: 4px; }"
                ...
                + "pre { font-family: 'JetBrains Mono', 'Fira Code', 'Consolas', monospace; background-color: #09090b; color: #f4f4f5; padding: 12px; border-radius: 8px; overflow-x: auto; font-size: 12px; border: 1px solid #3f3f46; line-height: 1.4; white-space: pre-wrap; word-wrap: break-word; }"
                ...
                + "th, td { border: 1px solid #3f3f46; padding: 8px 12px; text-align: left; font-size: 12px; }"
                ...
                + ".user-bubble { background-color: #252830; border: 1px solid #383d4a; border-radius: 8px; padding: 12px; margin-bottom: 14px; }"
                + ".ai-bubble { background-color: #1e1e24; border: 1px solid #33333d; border-radius: 8px; padding: 12px; margin-bottom: 14px; }"
                ...
                + ".traffic-card { background-color: #09090b; border: 1px solid #3f3f46; border-radius: 6px; padding: 10px; margin: 8px 0; }"
                + "</style></head><body>"
                + bodyHtml
                + "</body></html>";
    }
